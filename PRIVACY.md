# Privacy Policy — Info.plist Usage Description Companion

**Effective date:** 2026-09-07

Info.plist Usage Description Companion is a Gap Hunter Labs extension for Visual Studio Code. This
...
**Nothing.** Info.plist Usage Description Companion does not collect, store, transmit, or sell any
...
**None.** Info.plist Usage Description Companion makes zero network calls during normal operation.
...
None. Info.plist Usage Description Companion has no third-party SDKs, no analytics libraries, no
